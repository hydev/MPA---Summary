...
The transposition index matrix values are usually coded with colours, as shown in Figure ~\ref{figure:transpInxexMatrix}.
...
%-----------------------
 ...
 \begin{center}
 	...
 	\caption{(a) SSM from Figure ~\ref{fig:ssmPathSmoothing}. (b) SSM after thresholding and binarization $(\tau=0.75)$. (c) SSM after thresholding and scaling $(\rho=0.2)$. (d) SSM after thresholding and scaling $(\rho=0.05)$.
}
 \end{center}
...
Given a music recording, the objective of \textbf{audio thumbnailing} is to automatically determine the most representative section, which may serve as a kind of “preview". Often chorus or the main theme are good candidates. These parts are typically repeated several times, and so most procedures try to identify a section that has a certain minimal duration and many repetitions. The challenge is that sections may show significant musical differences.
